...
const contact = () => {
    return (
        <Layout>
        <SEO title="Kontakt" description="Skontaktuj się z nami. Fundacja Akcja Serducho. " />
        <main className="page contact-page contact-main-page">
            ...
            <header className="contact-page__header contact-main__header">
                ...
                <div className="contact-wrapper">
                    <ContactInfo name="Fundacja Akcja Serducho" tel="+48697875431" telLink="697 875 431" email="akcjaserducho@gmail.com" />
                    ...
                    <div className="contact-links">
                        <p className="contact-links__text">Możesz skontaktować się również bezpośrednio z naszym psychologiem lub pedagogiem</p>
                        <Link className="btn" to="/kontakt-psycholog">Kontakt - psycholog</Link>
                        <Link className="btn" to="/kontakt-pedagog">Kontakt - pedagog</Link>
                    </div>
                </div>
